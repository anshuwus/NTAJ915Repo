...
public class MultiDataSourceRunner implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		/*prodRepo.saveAll(Arrays.asList(new Product("table",100.0,60000.0),
				                       new Product("chair",10.0,66000.0),
				                       new Product("sofa",11.0,62000.0)));*/
		System.out.println("Products are saved");
		System.out.println("===================================");
		
		offersRepo.saveAll(Arrays.asList(new Offers("Buy-1-Get-1","B1G1",100.0,LocalDateTime.of(2023, 11,30,10,11)),new Offers("Buy-1-Get-2","B1G2",200.0,LocalDateTime.of(2023, 11,30,10,11)),new Offers("Buy-2-Get-2","B2G2",100.0,LocalDateTime.of(2023, 11,30,10,11))));
