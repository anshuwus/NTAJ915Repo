...
public class PandSRepTestRunner implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//System.out.println(service.deleteDoctorsByIdsInBatch(Arrays.asList(null)));
		
		Doctor doctor=new Doctor();
		doctor.setSpecialization("Ortho");doctor.setIncome(93200.0);
		service.showDoctorsByExampleData(doctor, true, "income").forEach(System.out::println);
		
		//System.out.println(service.findDoctorById(1));
		System.out.println(service.findDoctorById(2));
